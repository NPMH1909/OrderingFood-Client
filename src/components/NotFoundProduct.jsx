...
const NotFoundProduct = () => {
    ...
    return (
        <div>
            ...
            <div className="flex justify-center items-center h-full"> {/* Sử dụng h-full */}
                <h2 className="text-xl font-bold ">Không tìm thấy sản phẩm nào!</h2>
            </div>
            {/* Top Seller Section */}
            
            <div>
                <div className="ml-[6%]">
                    <p className="text-lg font-bold">Sản phẩm bán chạy</p>
                </div>
            ...
            <div className='mt-8'>
                <div className="ml-[6%]">
                    <p className="text-lg font-bold">Sản phẩm mới</p>
                </div>
                <div className="w-[90%] mx-auto">
                    <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
